...
import { FetchUnitService, UnitDeleteService } from '../../../services/ApiServices';
...
const UnitList = () => {
  ...
  const columns = [
    ...
    { field: 'unitName', headerName: 'Unit Name', width: 200 },
...
const deletUser = (id) => {
  UnitDeleteService({id}, handleDeleteSuccess, handleDeleteException);
}
...
useEffect(() => {
  FetchUnitService(handleFetchSuccess, handleFetchException);
